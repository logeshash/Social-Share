    ...
    <section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?= site_url(ADMIN_PATH.'/users/create')?>" class="form-horizontal validation" method="post">
              <div class="box-body">
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control validate[required, custom[email]]" id="inputEmail3" name="username" placeholder="UserName">
                  </div>
                </div>
                <div class="form-group required">
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control validate[required, custom[integer], minSize[10], maxSize[10]" id="inputEmail3" name="mobile" placeholder="Mobile">
                  </div>
                </div>
