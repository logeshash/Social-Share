...
/*
* Alternate for CI Session, using PHP SESSION, instead of Cookie
*/
class MY_Session extends CI_Session{
	...
	public function __construct($params = array())
	{
		...
		// Run the Session routine. If a session doesn't exist
		if(session_id() == null)
			session_start();
		...
		$this->set_userdata('ip_address', $this->getIP());
		$this->set_userdata('user_agent', $this->getUserAgent());
